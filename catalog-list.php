                            ...
                            <div class="catalog-box">
                                <div class="catalog-head ">
                                    ...
                                    <div class="btn-group-switch-view alignright">
                                        <button type="button" id="grid-view" class="btn" data-toggle="tooltip" title="" data-original-title="Сетка"><i class="icon-ic-grid"></i></button>
                                        <button type="button" id="list-view" class="btn active" data-toggle="tooltip" title="" data-original-title="Список"><i class="icon-ic-list-btn"></i></button>
                                    </div>
                                </div>
                                <div class="box-products  flexbox flex-wrap alignleft">
                                    <?php for($i=1; $i<11; $i++): ?>
                                    <?php include 'parts/item-type-3.php'; ?>
                                    <?php endfor; ?>
                                </div>
                                <!-- .box-products -->
                            </div>
